...
class LastNameScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    ...
    for(var i = 0; i < firstName.length; i++) {
      newCredentials.push(firstName[i]);
    }
  ...
  signIn() {
    ...
    if(lastName !== null && lastName.length > 0) {
      this.props.navigation.navigate('Email', {'lastName': credentials});
    ...
    return(
      <DismissKeyBoard>
        <SafeAreaView style={styles.container}>
          <Text style={styles.headerTitle}>Enter Last Name</Text>
